...
public class DocGenerator {
    ...
    public void process(File source, File target, int deep) throws Exception {
        ...
        if (source.isDirectory()) {
            ...
            if (name.endsWith(".adoc")) {
                ...
                html = injectToc(html, targetPath, deep);
    ...
    private String injectToc(String html, String targetPath, int deep) throws Exception {
        if (toc == null) {
        ...
        final String jsSource = "_res/scrollIntoView.js";
        
        Document jsoup = Jsoup.parse(html);
        jsoup.select("body").addClass("toc2");
        jsoup.select("#toc").before("<div id=\"toc\" class=\"toc2\">" + toc.toString() + 
                "<script src='" + StringUtils.repeat("../", deep) + jsSource + "'/></div>");
