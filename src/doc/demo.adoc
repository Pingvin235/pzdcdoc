...
The source page is: https://github.com/pzdcdoc/pzdcdoc/tree/master/src/doc/demo.adoc
====
...
link:../main/java/org/pzdcdoc/DocGenerator.java#L72-L76[org.pzdcdoc.DocGenerator]
