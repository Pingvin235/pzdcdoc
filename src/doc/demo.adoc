...
link:../main/java/org/pzdcdoc/DocGenerator.java#L79-L83[org.pzdcdoc.DocGenerator]
...
Content of class link:../main/java/org/pzdcdoc/processor/Snippet.java[org.pzdcdoc.processor.Snippet]
...
// TODO: Embedded in IDE editor.

// TODO: How to run converter container.

drawio:_res/diagram.drawio[]
