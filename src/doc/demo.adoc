...
IMPORTANT: Source diagram files must *not* be compressed and free of references to library image resources, these requirements are checked during generation and reported as errors case of violation
